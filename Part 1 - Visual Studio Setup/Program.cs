...
namespace SDLCSTutorial
{
    class Program
    {
        static void Main()
        {
            ...
            var window = SDL.SDL_CreateWindow("SDL .NET 5 Tutorial", SDL.SDL_WINDOWPOS_UNDEFINED, SDL.SDL_WINDOWPOS_UNDEFINED, 640, 480, SDL.SDL_WindowFlags.SDL_WINDOW_SHOWN);
